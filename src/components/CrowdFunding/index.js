                    ...
                    <table class="subscription-table responsive-table highlight">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><b>{(this.state.datos[0].blks).toFixed(0)}</b></td>
                            ...
                            <tr>
                                ...
                                <td><b>{(this.state.datos[1].blks).toFixed(0)}</b></td>
                            ...
                            <tr>
                                ...
                                <td><b>{(this.state.datos[2].blks).toFixed(0)}</b></td>
                            ...
                            <tr>
                                ...
                                <td><b>{(this.state.datos[3].blks).toFixed(0)}</b></td>
                            ...
                            <tr>
                                ...
                                <td><b>{(this.state.datos[4].blks).toFixed(0)}</b></td>
